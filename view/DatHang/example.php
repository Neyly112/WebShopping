                                ...
                                <div class="col-lg-6 px-5 py-4">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h5
                                                class="text-primary">áo
                                                đen quần trắng</h5>

                                            <div
                                                class="d-flex align-items-center">
                                                <p
                                                    class="fw-bold mb-0 me-5 pe-3">799$</p>
                                                <div
                                        ...
                                        <div
                                            ...
                                            <a href="#!"
                                                class="float-end text-black"><i
                                                    class="fas fa-times"></i></a>
                                            <h5
                                                class="text-primary">quần
                                                đen + áo</h5>

                                            <div
                                                class="d-flex align-items-center">
                                                <p
                                                    class="fw-bold mb-0 me-5 pe-3">239$</p>
                                                <div
                                                    class="def-number-input number-input safari_only">
                                                    <button
                                                        onclick="this.parentNode.querySelector('input[type=number]').stepDown()"
                                    ...
                                    <div
                                        ...
                                        <div class="flex-shrink-0">
                                            <img
                                                src="./products/Ecru White Modern Elegant Minimal Women_s Fashion Clothing Collection Instagram Story.png"
                                                class="img-fluid"
                                                style="width: 150px;"
                                                alt="Generic placeholder image">
                                        </div>
                                        <div
                                            ...
                                            <div
                                                class="d-flex align-items-center">
                                                <p
                                                    class="fw-bold mb-0 me-5 pe-3">659$</p>
                                                <div
                                                    class="def-number-input number-input safari_only">
                                                    <button
                                                        onclick="this.parentNode.querySelector('input[type=number]').stepDown()"
