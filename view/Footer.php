                ...
                <section class="p-3 pt-0">
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-md-5 col-lg-4 ml-lg-0 text-center text-md-end">
                            <!-- Facebook -->
                            <a class="btn btn-outline-dark btn-floating m-1" role="button" href="#"><img src="https://img.icons8.com/color/48/000000/facebook-new.png" alt="Facebook"></a>

                            <!-- zalo -->
                            <a class="btn btn-outline-dark btn-floating m-1" role="button" href="#"><img src="https://img.icons8.com/color/48/zalo.png" alt="Twitter"></a>
