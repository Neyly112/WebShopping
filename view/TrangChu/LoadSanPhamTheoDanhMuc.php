...
// echo 'Hello from load_to_dmsp.php';
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<p class="card-text">Mã ' . $row['MaSanPham'] . '</p>';
        echo '<p class="card-text" style="color: red;">' . $row['GiaBan'] . 'đ</p>';
        echo '</div>';
        echo '</a>';
    ...
    echo '<p class="text-secondary">Hiện chưa có các sản phẩm loại này. Vui lòng quay lại sau</p>';
}
mysqli_close($conn);
