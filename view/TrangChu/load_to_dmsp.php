...
?>
        ...
        <div class="col-md-3 mb-3">
            <div class="card">
                <a href="product.php?MaSanPham=<?php echo $row['$MaSanPham']; ?>">
                    <?php
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Mã Sản phẩm: <?php echo $row['MaSanPham']; ?><br>Mô tả: <?php echo $row['MoTa']; ?></p>
...
<?php
    ...
    if ($page > 1) {
?>
        <li class="page-item"><a class="page-link" href="?page=<?php echo $prevPage; ?>">Trang trước</a></li>
<?php
    }
    if ($page < $totalPages) {
?>
        <li class="page-item"><a class="page-link" href="?page=<?php echo $nextPage; ?>">Trang sau</a></li>
<?php
    }
?>
    </ul>
