...
<div class="container mt-4">
        ...
        <div class="row mb-4">
          <div class="col">
            <h2 style="font-family: 'Roboto', sans-serif; font-size: 24px; font-weight: bold" class="text-center mb-4 mt-4">SẢN PHẨM BÁN CHẠY</h2>
          </div>
        </div>
          ...
          <div class="col-lg-3 col-md-6 mb-4">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <head>
                ...
                <!-- Bootstrap CSS -->
                <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-KyZXEAg3QhqLMpG8r+Knujsl5+n7hF0nW/wDkYL+eP7h5Oe6U/mkkaduKaOQwpW6" crossorigin="anonymous">
              </head>
              <body>
              ...
              <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js" integrity="sha384-aNm7FREJN8AXCB7f/jfiNR0MzOe3HAsS/R7O+I3ZYscCr4s+SuRBLa2A6JPQ9Rq0" crossorigin="anonymous"></script>
              </body>
              </html>
