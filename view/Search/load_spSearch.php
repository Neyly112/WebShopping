...
$totalRows = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM `sanpham` WHERE TenSanPham LIKE '%$search%'"));
...
if ($result->num_rows > 0) {
    ...
    echo '<div class="container p-4 text-dark">';
    echo '<div> Không tìm thấy kết quả </div>';
    echo '</div>'; 
}
mysqli_close($conn);
?>
