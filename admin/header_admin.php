    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
          <a class="nav-link"  href="index.php?act=qldh">QUẢN LÝ ĐƠN HÀNG</a>
          </li>
          <li class="nav-item">
          <a class="nav-link "  href="index.php?act=qlsp">QUẢN LÝ SẢN PHẨM</a>
          </li>
          <li class="nav-item">
          <a class="nav-link "  href="index.php?act=dm">QUẢN LÝ DANH MỤC</a>
          </li>
        ...
        <!-- <form class="d-flex" action="./admin?act=search" method="POST">
